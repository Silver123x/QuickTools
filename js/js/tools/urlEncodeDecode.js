export function render(root){
  ...
  root.querySelector('#enc').addEventListener('click',()=>{ out.value=encodeURIComponent(input.value||''); });
  root.querySelector('#dec').addEventListener('click',()=>{ try{ out.value=decodeURIComponent(input.value||''); }catch(e){ out.value=''; } });
}
